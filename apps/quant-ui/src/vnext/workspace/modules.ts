...
export const vnextModules: VNextModule[] = [
  ...
  { id: "fuyao-research", path: "/fuyao-research", label: "Fuyao 研究工场", caption: "16 Best Practices", group: "research", icon: Database, keywords: "fuyao financial api best practice breakout momentum reversal cashflow heat report html 16 场景 最佳实践" },
