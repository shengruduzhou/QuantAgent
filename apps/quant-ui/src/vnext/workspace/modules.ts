...
export const vnextModules: VNextModule[] = [
  ...
  { id: "fuyao-research", path: "/fuyao-research", label: "Fuyao 契约中心", caption: "16 Best Practices Contract", group: "research", icon: Database, keywords: "fuyao financial api best practice contract pit provenance 16 场景 最佳实践 契约" },
  { id: "market-playbooks", path: "/market-playbooks", label: "Fuyao 执行工场", caption: "16 Executable Playbooks", group: "research", icon: Flask, keywords: "fuyao playbook breakout momentum reversal cashflow heat dragon tiger industry report 16 执行 回测 突破 动量 反转" },
  { id: "fund-research", path: "/fund-research", label: "基金研究台", caption: "Fund · ETF · REITs", group: "research", icon: ChartLine, keywords: "fund etf reits nav holdings holders returns 基金 ETF REITs 净值 持仓 持有人" },
  { id: "factor", path: "/factors", label: "因子实验室", caption: "Factor Lab", group: "research", icon: Atom, keywords: "factor alpha ic 因子" },
  { id: "fusion", path: "/fusion", label: "因子融合工场", caption: "Alpha Foundry", group: "research", icon: Sparkle, keywords: "fusion blend pareto frontier robustness pbo dsr spa 融合 前沿 稳健" },
  ...
  { id: "backtest", path: "/backtests", label: "回测工作站", caption: "Backtester", group: "research", icon: Flask, keywords: "backtest strategy experiment breakout momentum reversal t+1 回测 突破 动量 反转" },
  ...
  { id: "evidence", path: "/reports", label: "证据与报告", caption: "Evidence Center", group: "control", icon: FileText, keywords: "evidence report audit html pbo dsr spa 证据 报告" },
